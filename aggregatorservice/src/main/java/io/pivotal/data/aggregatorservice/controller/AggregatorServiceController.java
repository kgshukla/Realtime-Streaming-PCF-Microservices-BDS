...
public class AggregatorServiceController {
	...
	@RequestMapping(value = "/top10erringdrivers", method = RequestMethod.GET)
	public List<DriverIncorrectData> getTop10RErringDrivers() {
		return service.getTop10ErringDrivers();
	}
	
	@RequestMapping(value = "/top10earningdrivers", method = RequestMethod.GET)
