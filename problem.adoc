...
First you need to clone (git clone) the repository on your laptop. I have uploaded jar files already, so you don't need to compile the code, however, if you want to do some changes and recompile, run mvn clean package (you need to have maven installed on your laptop) inside top directory
